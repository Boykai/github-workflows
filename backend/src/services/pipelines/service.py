...
_PRESET_DEFINITIONS = [
    {
        ...
        "stages": [
            {"id": "preset-sk-stage-1", "name": "Specify", "order": 0, "agents": [
                {"id": "preset-sk-agent-1", "agent_slug": "speckit-specify", "agent_display_name": "Spec Writer",
                 "model_id": "", "model_name": "", "tool_ids": [], "tool_count": 0, "config": {}}
            ]},
            {"id": "preset-sk-stage-2", "name": "Plan", "order": 1, "agents": [
                {"id": "preset-sk-agent-2", "agent_slug": "speckit-plan", "agent_display_name": "Planner",
                 "model_id": "", "model_name": "", "tool_ids": [], "tool_count": 0, "config": {}}
            ]},
            {"id": "preset-sk-stage-3", "name": "Tasks", "order": 2, "agents": [
                {"id": "preset-sk-agent-3", "agent_slug": "speckit-tasks", "agent_display_name": "Task Generator",
                 "model_id": "", "model_name": "", "tool_ids": [], "tool_count": 0, "config": {}}
            ]},
            {"id": "preset-sk-stage-4", "name": "Implement", "order": 3, "agents": [
                {"id": "preset-sk-agent-4", "agent_slug": "speckit-implement", "agent_display_name": "Implementer",
                 "model_id": "", "model_name": "", "tool_ids": [], "tool_count": 0, "config": {}}
            ]},
            {"id": "preset-sk-stage-5", "name": "Analyze", "order": 4, "agents": [
                {"id": "preset-sk-agent-5", "agent_slug": "speckit-analyze", "agent_display_name": "Analyzer",
                 "model_id": "", "model_name": "", "tool_ids": [], "tool_count": 0, "config": {}}
            ]},
        ],
    },
    {
        ...
        "stages": [
            {"id": "preset-gc-stage-1", "name": "Execute", "order": 0, "agents": [
                {"id": "preset-gc-agent-1", "agent_slug": "copilot", "agent_display_name": "GitHub Copilot",
                 "model_id": "gpt-4o", "model_name": "GPT-4o", "tool_ids": [], "tool_count": 0, "config": {}}
            ]},
        ],
    },
]
