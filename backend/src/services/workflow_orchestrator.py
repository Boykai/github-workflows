...
"""
    ...
    # ──────────────────────────────────────────────────────────────────
    async def add_to_project_with_backlog(self, ctx: WorkflowContext) -> str:
        """
    ...
    async def handle_ready_status(self, ctx: WorkflowContext) -> bool:
        """
        When Ready status detected: assign GitHub Copilot and transition to In Progress.
        ...
        # Try to assign GitHub Copilot Agent first
        ...
        self.log_transition(
            ...
            triggered_by=TriggeredBy.AUTOMATIC,
            success=True,
            assigned_user="copilot" if copilot_assigned else config.copilot_assignee,
        )

        return True

    # ──────────────────────────────────────────────────────────────────
    # STEP 5: Detect Completion Signal (T044)
    # ──────────────────────────────────────────────────────────────────
    ...
    async def execute_full_workflow(
        ...
        try:
            ...
            await self.add_to_project_with_backlog(ctx)
