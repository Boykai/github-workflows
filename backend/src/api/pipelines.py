...
# ── List Models ──
# Static-path routes MUST be defined before parameterized routes because
# Starlette matches routes in definition order; otherwise "models" would
# be captured as a {project_id} parameter.
