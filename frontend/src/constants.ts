...
/** Centralized color classes for operational states (connected, warning, error, etc.). */
...
export const AGENT_SOURCE_COLORS: Record<string, { bg: string; text: string }> = {
  ...
  repository: { bg: 'bg-green-500/10 dark:bg-green-500/15', text: 'text-green-600 dark:text-green-400' },
  repo: { bg: 'bg-green-500/10 dark:bg-green-500/15', text: 'text-green-600 dark:text-green-400' },
