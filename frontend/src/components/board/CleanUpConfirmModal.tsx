          ...
          <div className="mb-4">
            ...
            <ul className="space-y-1 text-sm">
              {data.branches_to_preserve.map((branch) => (
                <li key={branch.name} className="flex items-center gap-2 px-2 py-1 rounded bg-green-500/10">
                  <span className="font-mono text-xs">{branch.name}</span>
          ...
          <div className="mb-4">
            ...
            <ul className="space-y-1 text-sm">
              {data.prs_to_preserve.map((pr) => (
                <li key={pr.number} className="flex items-center gap-2 px-2 py-1 rounded bg-green-500/10">
                  <span className="font-medium">#{pr.number}</span>
                  <span className="text-muted-foreground truncate">{pr.title}</span>
