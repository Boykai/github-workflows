  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      <div
        ...
        role="presentation"
      />
      <div className="relative z-10 w-full max-w-md mx-4 rounded-lg border border-border bg-background shadow-xl max-sm:max-w-none max-sm:h-auto max-sm:rounded-none max-sm:mx-0 max-sm:border-0">
        {step === 1 ? (
