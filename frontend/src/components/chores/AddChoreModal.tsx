  ...
  if (showChatFlow) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div className="celestial-panel relative z-10 mx-4 w-full max-w-lg rounded-[1.4rem] border border-border shadow-xl max-sm:max-w-none max-sm:h-full max-sm:rounded-none max-sm:mx-0 max-sm:border-0">
