...
export function UploadMcpModal({
  ...
  return (
    ...
    >
      <div
        className="celestial-panel w-full max-w-lg max-h-[85vh] overflow-y-auto rounded-[1.4rem] border border-border p-6 shadow-lg max-sm:max-w-none max-sm:max-h-none max-sm:h-full max-sm:rounded-none max-sm:border-0 max-sm:p-4"
        role="presentation"
