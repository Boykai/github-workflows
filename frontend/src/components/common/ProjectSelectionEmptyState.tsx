  ...
  return (
    <div className="celestial-panel flex flex-1 flex-col items-center justify-center rounded-[1.4rem] border border-dashed border-border/80 bg-background/26 p-6 text-center sm:rounded-[1.5rem] sm:p-8">
      <div className="flex w-full max-w-xl flex-col items-center">
        <div className="relative mb-5 flex h-24 w-24 items-center justify-center rounded-full">
          <div className="absolute inset-0 rounded-full border border-border/40 bg-[radial-gradient(circle_at_center,hsl(var(--glow)/0.18)_0%,transparent_64%)]" />
