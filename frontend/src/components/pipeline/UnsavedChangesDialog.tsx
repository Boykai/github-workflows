...
export function UnsavedChangesDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Dialog */}
      <div className="relative z-10 mx-4 w-full max-w-md rounded-2xl border border-border/80 bg-card p-6 shadow-xl max-sm:max-w-none max-sm:h-auto max-sm:rounded-none max-sm:mx-0 max-sm:border-0">
