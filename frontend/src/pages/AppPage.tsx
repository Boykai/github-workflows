...
const quickLinks = [
  ...
  },
  {
    ...
    description: 'Visualize your agent workflow',
    icon: GitBranch,
  },
        ...
        <section className="flex min-h-[34rem] flex-col justify-between">
          ...
          <div>
            ...
            <p className="mt-6 max-w-lg text-lg leading-8 text-muted-foreground">
              ...
              feels more like a ritual workspace than a utility dashboard.
            </p>
          </div>
              ...
              <div className="mt-4 flex items-start justify-between gap-6">
                <div>
                  ...
                  <p className="mt-3 text-sm leading-6 text-muted-foreground">
                    The shell, navigation, and calls to action now carry more of the illustrated Sun
                    & Moon tension without crowding the app’s real work.
                  </p>
                </div>
