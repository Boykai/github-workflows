---
name: Bug Bash
about: Recurring chore — Bug Bash
title: '[CHORE] Bug Bash'
labels: chore
assignees: ''
---

## Bug Bash: Full Codebase Review & Fix — `Boykai/github-workflows` (`main` branch)

### Objective
Perform a comprehensive bug bash code review of the **entire codebase** on the `main` branch of `Boykai/github-workflows`. Identify bugs, fix them, and ensure fixes are validated by tests.
