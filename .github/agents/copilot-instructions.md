...
- TypeScript 5.4 (Frontend), Python 3.11+ (Backend) + React 18.3, Vite 5.4 (Frontend), FastAPI 0.109+ (Backend) (001-pottery-title)
- N/A (text file changes only) (001-pottery-title)
...
## Recent Changes
- 001-pottery-title: Added TypeScript 5.4 (Frontend), Python 3.11+ (Backend) + React 18.3, Vite 5.4 (Frontend), FastAPI 0.109+ (Backend)
