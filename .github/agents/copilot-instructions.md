...
- Python ≥3.11 (pyright targets 3.12), TypeScript ~5.4 + FastAPI ≥0.109, React 18.3, TanStack Query v5, Vite 5, httpx ≥0.26, pydantic ≥2.5, aiosqlite ≥0.20, socket.io-client 4.7, dnd-kit 6.3 (010-bug-bash)
...
- Python 3.11+ (backend), TypeScript 5.4 (frontend) + FastAPI, Uvicorn, python-jose, Pydantic, aiosqlite (backend); React 18.3, Vite, Radix UI, TanStack Query (frontend) (012-deep-security-review)
- SQLite via aiosqlite (`/app/data/settings.db`) (012-deep-security-review)
...
## Recent Changes
- 012-deep-security-review: Added Python 3.11+ (backend), TypeScript 5.4 (frontend) + FastAPI, Uvicorn, python-jose, Pydantic, aiosqlite (backend); React 18.3, Vite, Radix UI, TanStack Query (frontend)
