...
- Python 3.12 (backend), TypeScript/React (frontend) + FastAPI (backend), Vite + React (frontend), Playwright (E2E tests) (007-app-title-happy-place)
- N/A — no storage changes (007-app-title-happy-place)
...
## Recent Changes
- 007-app-title-happy-place: Added Python 3.12 (backend), TypeScript/React (frontend) + FastAPI (backend), Vite + React (frontend), Playwright (E2E tests)
