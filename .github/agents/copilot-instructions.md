...
- TypeScript ~5.9 (frontend) + React 19.2, Tailwind CSS v4, lucide-react 0.577, class-variance-authority 0.7 (030-confirmation-dialog)
- N/A — purely frontend component; no database changes (030-confirmation-dialog)
