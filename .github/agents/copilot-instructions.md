...
- Python 3.11+ (backend), TypeScript 5.4+ (frontend) + FastAPI, Pydantic, Pillow (image processing), React 18, TanStack Query, Vite (001-profile-picture-upload)
- Local file system (`/backend/storage/profile-pictures/`) with future cloud migration path (001-profile-picture-upload)
...
## Recent Changes
- 001-profile-picture-upload: Added Python 3.11+ (backend), TypeScript 5.4+ (frontend) + FastAPI, Pydantic, Pillow (image processing), React 18, TanStack Query, Vite
