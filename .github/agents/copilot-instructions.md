...
- TypeScript 5.x (frontend), Python 3.11+ (backend), HTML5 + React 18, Vite 5, FastAPI 0.109+, Playwright (E2E) (007-update-app-name)
- N/A (static content changes only) (007-update-app-name)
...
## Recent Changes
- 007-update-app-name: Added TypeScript 5.x (frontend), Python 3.11+ (backend), HTML5 + React 18, Vite 5, FastAPI 0.109+, Playwright (E2E)
