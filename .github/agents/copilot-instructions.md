...
- TypeScript ~5.4 (frontend), CSS3 with Tailwind CSS 3.4 + React 18.3, Tailwind CSS 3.4, tailwindcss-animate, Vite (018-golden-background)
- N/A (no data persistence changes) (018-golden-background)
