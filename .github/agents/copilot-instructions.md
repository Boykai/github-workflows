...
- TypeScript 5.x (frontend), Python 3.11 (backend) + React 18.3.1, Vitest 4.x, @vitest/coverage-v8 (frontend); FastAPI, pytest 7.4+, pytest-cov, pytest-asyncio (backend) (001-test-coverage-bugfix)
- SQLite (settings store via aiosqlite) (001-test-coverage-bugfix)
...
## Recent Changes
- 001-test-coverage-bugfix: Added TypeScript 5.x (frontend), Python 3.11 (backend) + React 18.3.1, Vitest 4.x, @vitest/coverage-v8 (frontend); FastAPI, pytest 7.4+, pytest-cov, pytest-asyncio (backend)
