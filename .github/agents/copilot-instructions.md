...
- TypeScript ~5.4 (frontend) + React 18, @tanstack/react-query v5, Vite 5 (009-black-background)
- N/A (theme persistence already handled via `localStorage` + user settings API) (009-black-background)
...
## Recent Changes
- 009-black-background: Added TypeScript ~5.4 (frontend) + React 18, @tanstack/react-query v5, Vite 5
