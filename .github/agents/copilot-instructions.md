...
## Active Technologies
- Python ≥3.12 (backend), TypeScript/Node 25 (frontend) + FastAPI ≥0.135.0, React 19, Vite 8, nginx (Alpine), slowapi ≥0.1.9, cryptography ≥46.0.5 (001-security-review)
- SQLite via aiosqlite ≥0.22.0 (path: `/var/lib/solune/data/settings.db`) (001-security-review)
