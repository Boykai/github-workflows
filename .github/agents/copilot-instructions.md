...
## Active Technologies
- Python ≥3.12 (target 3.13), TypeScript 5.9, Node 25 + FastAPI 0.135+, React 19.2, Vite 8.0, Pydantic 2.12+, React Query 5.91+, Zod 4.3+ (001-bug-basher)
- SQLite (async via aiosqlite) at `/var/lib/solune/data/settings.db` (001-bug-basher)
