...
- TypeScript 5.x (React 18 frontend), CSS3 with Tailwind CSS + React 18, Tailwind CSS 3.x, shadcn/ui component library, `tailwindcss-animate` (018-ruby-background-theme)
- N/A (frontend-only styling change) (018-ruby-background-theme)
