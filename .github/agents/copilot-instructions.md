...
- TypeScript ~5.4 (frontend), Python 3.12 (backend — no changes needed) + React 18.3, Vite (build), Playwright (E2E tests), Vitest (unit tests) (005-goodbye-app-title)
- N/A — no data persistence involved (005-goodbye-app-title)
...
## Recent Changes
- 005-goodbye-app-title: Added TypeScript ~5.4 (frontend), Python 3.12 (backend — no changes needed) + React 18.3, Vite (build), Playwright (E2E tests), Vitest (unit tests)
