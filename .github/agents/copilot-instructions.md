...
- TypeScript ~5.4 (frontend) + React 18.3, Vite 5.4 (008-add-yellow-background)
- N/A (CSS-only change) (008-add-yellow-background)
...
## Recent Changes
- 008-add-yellow-background: Added TypeScript ~5.4 (frontend) + React 18.3, Vite 5.4
