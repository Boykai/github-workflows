...
- TypeScript ~5.4 (frontend), Python 3.12 (backend — no changes) + React 18.3, Vite 5.4 (no new dependencies) (007-teal-background)
- N/A (CSS-only change) (007-teal-background)
...
## Recent Changes
- 007-teal-background: Added TypeScript ~5.4 (frontend), Python 3.12 (backend — no changes) + React 18.3, Vite 5.4 (no new dependencies)
