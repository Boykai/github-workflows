...
- Python 3.11 (backend), TypeScript 5.x (frontend) + FastAPI, React 18, TanStack Query v5, shadcn/ui, Tailwind CSS (012-settings-dynamic-ux)
- SQLite via aiosqlite (existing), in-memory TTL cache (new backend cache layer) (012-settings-dynamic-ux)
...
## Recent Changes
- 012-settings-dynamic-ux: Added Python 3.11 (backend), TypeScript 5.x (frontend) + FastAPI, React 18, TanStack Query v5, shadcn/ui, Tailwind CSS
