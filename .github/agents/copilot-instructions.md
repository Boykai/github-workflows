...
- TypeScript 5.4 (frontend), Python 3.12 (backend — no changes needed) + React 18.3, Vite 5.4, TailwindCSS 3.4, shadcn/ui (Radix UI primitives) (016-green-background)
...
## Recent Changes
- 016-green-background: Added TypeScript 5.4 (frontend), Python 3.12 (backend — no changes needed) + React 18.3, Vite 5.4, TailwindCSS 3.4, shadcn/ui (Radix UI primitives)
