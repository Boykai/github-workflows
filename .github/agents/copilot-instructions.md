...
- Python 3.12+ + FastAPI, aiosqlite, githubkit (GitHub SDK), httpx, Pydantic (033-fix-silent-failures-security)
- SQLite via aiosqlite (async) (033-fix-silent-failures-security)
...
## Recent Changes
- 033-fix-silent-failures-security: Added Python 3.12+ + FastAPI, aiosqlite, githubkit (GitHub SDK), httpx, Pydantic
