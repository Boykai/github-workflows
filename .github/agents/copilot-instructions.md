...
- TypeScript ~5.9 (frontend-only change) + React 19.2, existing command system (`frontend/src/lib/commands/`) (032-chat-help-command)
- N/A — ephemeral local messages only; no persistence changes (032-chat-help-command)
