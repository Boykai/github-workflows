...
- Python >=3.12 (backend; target 3.13 in tooling), TypeScript 5.x (frontend) + FastAPI, aiosqlite, Pydantic, OpenAI SDK, Sentry (backend); React 19.2, TanStack Query, Vite, lucide-react, Tailwind CSS 4 (frontend) (001-bug-basher)
