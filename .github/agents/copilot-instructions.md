...
- Python 3.11 (backend), TypeScript 5.x / React 19 (frontend) + FastAPI, Pydantic, pytest (backend); Vite, Vitest, React Testing Library (frontend) (049-transcript-upload-transcribe)
