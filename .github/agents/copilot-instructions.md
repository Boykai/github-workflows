...
- TypeScript ~5.4, React 18.3 + React, Vite 5.4, @tanstack/react-query (001-tan-background)
...
## Recent Changes
- 001-tan-background: Added TypeScript ~5.4, React 18.3 + React, Vite 5.4, @tanstack/react-query
