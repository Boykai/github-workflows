...
- Python 3.12 (backend), TypeScript 5.4 (frontend) + FastAPI, Pydantic v2, aiosqlite, httpx (backend); React 18, Vite 5.4, TanStack Query v5, Tailwind CSS 3.4, Shadcn UI (frontend) (002-codebase-cleanup)
- SQLite WAL via aiosqlite (backend persistent storage) (002-codebase-cleanup)
...
## Recent Changes
- 002-codebase-cleanup: Added Python 3.12 (backend), TypeScript 5.4 (frontend) + FastAPI, Pydantic v2, aiosqlite, httpx (backend); React 18, Vite 5.4, TanStack Query v5, Tailwind CSS 3.4, Shadcn UI (frontend)
