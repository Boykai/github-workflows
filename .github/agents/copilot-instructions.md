...
- TypeScript 5.4 (Frontend), Python 3.11 (Backend) + React 18.3, Vite 5.4, CSS Custom Properties (Frontend); FastAPI (Backend - not involved in theming) (001-pink-theme)
- Browser localStorage for theme preference persistence (001-pink-theme)
...
## Recent Changes
- 001-pink-theme: Added TypeScript 5.4 (Frontend), Python 3.11 (Backend) + React 18.3, Vite 5.4, CSS Custom Properties (Frontend); FastAPI (Backend - not involved in theming)
