...
- TypeScript ~5.4, React 18.3, ES2022 target + React 18, Vite 5, @tanstack/react-query 5, CSS custom properties (no CSS framework) (008-green-background)
- N/A (frontend-only change) (008-green-background)
...
## Recent Changes
- 008-green-background: Added TypeScript ~5.4, React 18.3, ES2022 target + React 18, Vite 5, @tanstack/react-query 5, CSS custom properties (no CSS framework)
