...
- TypeScript (frontend, Vite + React), Python 3.11 (backend, FastAPI) + React, FastAPI, Playwright (E2E tests) (007-app-title-happy-place)
- N/A — no data model changes (007-app-title-happy-place)
...
## Recent Changes
- 007-app-title-happy-place: Added TypeScript (frontend, Vite + React), Python 3.11 (backend, FastAPI) + React, FastAPI, Playwright (E2E tests)
