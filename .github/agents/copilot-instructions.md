...
- TypeScript 5.4 (frontend), Python 3.11+ (backend) + React 18, Vite 5, @tanstack/react-query, socket.io-client, @dnd-kit (frontend); FastAPI, uvicorn, httpx, pydantic 2, aiosqlite (backend) (001-test-coverage-bugfix)
- SQLite via aiosqlite (backend) (001-test-coverage-bugfix)
...
## Recent Changes
- 001-test-coverage-bugfix: Added TypeScript 5.4 (frontend), Python 3.11+ (backend) + React 18, Vite 5, @tanstack/react-query, socket.io-client, @dnd-kit (frontend); FastAPI, uvicorn, httpx, pydantic 2, aiosqlite (backend)
