...
- Python ≥3.11 (backend), TypeScript ~5.4 (frontend) + FastAPI ≥0.109, Pydantic ≥2.5, React 18.3, Vite 5.4, Tailwind CSS 3.4 (018-code-cleanup)
- aiosqlite (async SQLite) with raw SQL migrations (018-code-cleanup)
