...
- TypeScript ~5.4 (frontend), React 18 + React 18, @tanstack/react-query v5, Vite 5 (010-brown-background)
- N/A (CSS-only change) (010-brown-background)
...
## Recent Changes
- 010-brown-background: Added TypeScript ~5.4 (frontend), React 18 + React 18, @tanstack/react-query v5, Vite 5
