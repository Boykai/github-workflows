...
- TypeScript 5.4 (frontend), Python (backend - not impacted) + React 18.3, Vite 5.4, CSS custom properties for theming (002-blue-background)
- localStorage for theme persistence (existing useAppTheme hook) (002-blue-background)
