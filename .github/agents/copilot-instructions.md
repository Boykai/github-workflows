...
- Python ≥3.12 (target 3.13) backend; TypeScript ~5.9 / React 19.2 frontend + FastAPI ≥0.135, githubkit, Pydantic 2.12, aiosqlite (backend); Vite 7.3, @tanstack/react-query 5.90, Zod 4.3, react-hook-form 7.71 (frontend) (049-increase-test-coverage)
