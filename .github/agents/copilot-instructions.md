...
- TypeScript ~5.9 / React 19 (frontend-only change) + React 19, TanStack Query, Vitest (testing) (033-chat-help-command)
- N/A — ephemeral local state only, no backend persistence (033-chat-help-command)
