...
- Python 3.12 (backend), TypeScript ~5.4 (frontend) + FastAPI ≥0.109 (backend); React 18.3, Vite (frontend) (005-update-app-title)
...
## Recent Changes
- 005-update-app-title: Added Python 3.12 (backend), TypeScript ~5.4 (frontend) + FastAPI ≥0.109 (backend); React 18.3, Vite (frontend)
