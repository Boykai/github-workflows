...
- TypeScript 5.x, React 18.3.1 + Vite (build tool), React DOM, TanStack React Query (002-yellow-background)
- N/A (styling change only) (002-yellow-background)
...
## Recent Changes
- 002-yellow-background: Added TypeScript 5.x, React 18.3.1 + Vite (build tool), React DOM, TanStack React Query
