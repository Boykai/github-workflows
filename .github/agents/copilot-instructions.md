...
- Python 3.13 (backend), TypeScript 5.x (frontend) + FastAPI, aiosqlite, Pydantic, OpenAI SDK, Sentry (backend); React 18, TanStack Query, Vite, lucide-react, Tailwind CSS 4 (frontend) (001-bug-basher)
