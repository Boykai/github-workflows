...
- TypeScript ~5.9 (frontend-only feature) + React 19.2, Tailwind CSS v4.2 (no new dependencies) (032-chat-help-command)
- N/A — ephemeral local messages only; no database or localStorage changes (032-chat-help-command)
