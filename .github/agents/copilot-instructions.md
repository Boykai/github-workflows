...
## Active Technologies
- Python ≥3.12 (backend), TypeScript/React (frontend), nginx (reverse proxy) + FastAPI, Pydantic, aiosqlite, cryptography, slowapi (backend); React, Vite, TanStack Query (frontend) (001-security-review)
- SQLite via aiosqlite (durable settings/session storage), encrypted at rest with Fernet (001-security-review)
