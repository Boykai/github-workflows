...
## Active Technologies
- Python 3.14 (backend), TypeScript ~5.9 / Node 25 (frontend) + FastAPI 0.135+, React 19.2, Vite 8, nginx 1.29-alpine, pydantic-settings, aiosqlite, cryptography 46, slowapi 0.1.9+ (001-security-review)
- SQLite via aiosqlite at `/var/lib/solune/data/settings.db` (001-security-review)
