...
- TypeScript 5.4, React 18.3.1 + Vite 5.4 (build tool), React 18.3.1, CSS3 custom properties (001-blue-background)
- localStorage (theme persistence via useAppTheme hook) (001-blue-background)
...
## Recent Changes
- 001-blue-background: Added TypeScript 5.4, React 18.3.1 + Vite 5.4 (build tool), React 18.3.1, CSS3 custom properties
