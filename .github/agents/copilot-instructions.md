...
- TypeScript ~5.4.0 (frontend), Python 3.11+ (backend) + React 18.3, Vite 5.4, FastAPI 0.109+ (005-app-title-update)
- N/A (no data model changes) (005-app-title-update)
...
## Recent Changes
- 005-app-title-update: Added TypeScript ~5.4.0 (frontend), Python 3.11+ (backend) + React 18.3, Vite 5.4, FastAPI 0.109+
