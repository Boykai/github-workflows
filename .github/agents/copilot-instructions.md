...
- Python 3.12 (backend), TypeScript ~5.4 (frontend) + FastAPI ≥0.109 (backend); React 18.3, Playwright (frontend E2E) (007-app-title-ready-set-go)
...
## Recent Changes
- 007-app-title-ready-set-go: Added Python 3.12 (backend), TypeScript ~5.4 (frontend) + FastAPI ≥0.109 (backend); React 18.3, Playwright (frontend E2E)
