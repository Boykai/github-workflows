...
- TypeScript 5.x with React 19.2 + React 19, TanStack React Query 5.90, Tailwind CSS v4 (via `@tailwindcss/vite`), Radix UI (Slot, Tooltip), Lucide React icons, class-variance-authority, tailwind-merge, react-router-dom 7.13, react-markdown 10.1, @dnd-kit (drag-and-drop) (033-projects-page-audit)
- N/A (frontend-only; backend uses SQLite with FastAPI) (033-projects-page-audit)
