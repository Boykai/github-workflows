...
- Local filesystem (uploads/ directory) with structure for cloud migration (001-chat-document-upload)
...
## Recent Changes
- 001-chat-document-upload: Added Python 3.11+ (backend), TypeScript 5.x (frontend)
