/**
 * PipelineStagesOverview — Displays board columns with assigned agents for
 * the pipeline page. Extracted from AgentsPipelinePage for modularity.
 */
...
export interface PipelineStagesOverviewProps {
  columns: BoardColumn[];
  ...
  return (
    <div>
      ...
      <div className="overflow-x-auto pb-2">
        <div className="grid min-w-full items-stretch gap-3" style={gridStyle}>
          {columns.map((col) => {
