/**
 * Essential Settings component.
 *
 * Renders the most important settings on the Essential tab:
 * model provider, chat model (dynamic dropdown), GitHub agent model
 * (dynamic dropdown), and temperature slider. Signal Connection
 * has been moved to the Preferences tab.
 */
...
export function EssentialSettings({ settings, onSave }: EssentialSettingsProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        <label htmlFor="essential-provider" className="text-sm font-medium text-foreground">
          Model Provider
        </label>
        <select
      ...
      {/* Temperature */}
      <div className="flex flex-col gap-2">
        <label htmlFor="essential-temperature" className="text-sm font-medium text-foreground">
          Temperature: {localState.temperature.toFixed(1)}
        </label>
        <input
          id="essential-temperature"
          type="range"
