# Quickstart: Audit & Polish Projects Page for Visual Cohesion and UX Quality
...
```bash
# Clone and checkout
git checkout 034-projects-page-audit
...
# ProjectsPage tests specifically
...
|----------|------|-------|-------------|
| HIGH | `src/pages/ProjectsPage.tsx` | ~749 | Main page — all states, banners, inline components |
