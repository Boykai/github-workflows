# Cache Contract: Performance Review — Balanced First Pass
...
Stale time:     STALE_TIME_SHORT (60 seconds, configured per hook)
...
Stale time:     STALE_TIME_PROJECTS (15 minutes, configured per hook)
...
| Cache full (bounded dict capacity) | FIFO eviction of oldest entries (existing `BoundedDict` behavior for inflight dedup) |
