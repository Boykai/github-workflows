...
**Requirements**: FR-003–FR-013, FR-020 | **Success Criteria**: SC-002, SC-003, SC-004

## Overview

Three review checklists exist in `docs/checklists/` for weekly, monthly, and quarterly cadences. This contract defines the required content for each and validates the existing implementations against 030-doc-sweep requirements.
...
### Required Content (FR-007–FR-010, FR-020)
...
|-----------|------|--------|------|
| Weekly sweep | `docs/checklists/weekly-sweep.md` | ✅ Exists | Verify content covers FR-004–FR-006 specifics |
| Monthly review | `docs/checklists/monthly-review.md` | ✅ Exists | Verify content covers FR-008–FR-010 + FR-020 |
| Quarterly audit | `docs/checklists/quarterly-audit.md` | ✅ Exists | Verify content covers FR-012 ADR format + FR-013 DX test |

## Changes Required

Verify each existing checklist against the contract above during implementation. If any specific items are missing, add them. The contract serves as the authoritative specification for checklist content.
