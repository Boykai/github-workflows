...
- Assumptions section documents reasonable defaults for unspecified details (cache TTLs, debounce intervals, rate-limit thresholds).
- Scope is explicitly bounded: first-pass low-risk optimizations only, with virtualization and service decomposition deferred unless baselines prove them necessary.
