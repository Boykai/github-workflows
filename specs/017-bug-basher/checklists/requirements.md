...
- The spec covers all five bug categories in priority order: security, runtime, logic, test quality, code quality.
- Ambiguous issues are handled via `TODO(bug-bash)` comments rather than code changes, which is documented in the Assumptions section.
