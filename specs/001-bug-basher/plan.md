...
│   │   ├── services/         # 33 top-level service modules + 7 sub-packages (agents, chores, copilot_polling, github_projects, pipelines, tools, workflow_orchestrator)
│   │   ├── middleware/        # 5 middleware components (admin_guard, rate_limit, csrf, csp, request_id)
