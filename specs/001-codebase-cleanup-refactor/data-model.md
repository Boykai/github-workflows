...
services/copilot_polling/      →  replaces copilot_polling.py (3,948 lines)
...
| `BOARD_POLL_INTERVAL_MS` | `15000` | Board polling interval (reference; removed from useProjectBoard) |
| `WS_MAX_RECONNECT_ATTEMPTS` | `3` | Max WS reconnection attempts before fallback |
| `AUTH_STALE_TIME_MS` | `300000` | Auth/settings check cache duration (5 min) |
| `TASKS_STALE_TIME_MS` | `60000` | Tasks data cache duration (1 min) |
| `DATA_STALE_TIME_MS` | `10000` | Generic data cache duration (10 sec) |
| `CHAT_EXPIRES_OFFSET_MS` | `600000` | Chat expiry offset (10 min) |
