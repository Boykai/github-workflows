...
**Created**: 2026-03-07  
**Feature**: [specs/027-performance-review/spec.md](../spec.md)
...
- The specification references Spec 022 alignment as a prerequisite (FR-013) but avoids prescribing implementation details.
