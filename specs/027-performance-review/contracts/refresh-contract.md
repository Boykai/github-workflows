...
**Trigger**: WebSocket connection failed; polling at `WS_FALLBACK_POLL_MS` interval
...
2. **Reconnection debounce**: Multiple WebSocket reconnections within 2 seconds produce at most one task invalidation.
