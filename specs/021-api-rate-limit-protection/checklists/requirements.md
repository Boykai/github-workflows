...
- The spec intentionally avoids naming specific technologies (no mentions of githubkit, GraphQL, REST, Redis, etc.) to remain technology-agnostic per the guidelines.
