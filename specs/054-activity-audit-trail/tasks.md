...
- [x] T001 Create database migration with activity_events table and indexes in solune/backend/src/migrations/032_activity_events.sql
...
- [x] T002 Create ActivityEvent and ActivityEventCreate Pydantic models in solune/backend/src/models/activity.py
...
- [x] T003 [P] Create fire-and-forget activity logger service in solune/backend/src/services/activity_logger.py
...
- [x] T004 Create activity feed API router with two GET endpoints in solune/backend/src/api/activity.py
...
- [x] T005 Register activity router in solune/backend/src/api/__init__.py
...
- [x] T006 [P] Add ActivityEvent TypeScript interface in solune/frontend/src/types/index.ts
...
- [x] T007 Add activityApi.feed() and activityApi.entityHistory() methods in solune/frontend/src/services/api.ts
...
- [x] T008 [P] [US1] Add log_event() calls for pipeline run lifecycle in solune/backend/src/api/pipelines.py
...
- [x] T009 [P] [US1] Add log_event() calls for workflow transitions in solune/backend/src/services/workflow_orchestrator/orchestrator.py
...
- [x] T010 [P] [US1] Add log_event() calls for chore triggers and CRUD in solune/backend/src/api/chores.py
...
- [x] T011 [P] [US1] Add log_event() calls for agent CRUD in solune/backend/src/api/agents.py
...
- [x] T012 [P] [US1] Add log_event() calls for app CRUD and lifecycle in solune/backend/src/api/apps.py
...
- [x] T013 [P] [US1] Add log_event() calls for tool CRUD in solune/backend/src/api/tools.py
...
- [x] T014 [P] [US1] Add log_event() calls for inbound webhook events in solune/backend/src/api/webhooks.py
...
- [x] T015 [P] [US1] Add log_event() calls for cleanup operations in solune/backend/src/api/cleanup.py
...
- [x] T016 [US1] Create useActivityFeed hook in solune/frontend/src/hooks/useActivityFeed.ts
...
- [x] T017 [US1] Create ActivityPage with event timeline, expand detail, icons, and empty state in solune/frontend/src/pages/ActivityPage.tsx
...
- [x] T018 [US1] Add /activity route in solune/frontend/src/App.tsx
...
- [x] T019 [P] [US1] Add Activity nav link with Clock icon to NAV_ROUTES in solune/frontend/src/constants.ts
...
- [x] T020 [US2] Add event type filter chips UI to ActivityPage in solune/frontend/src/pages/ActivityPage.tsx
...
- [x] T021 [US2] Ensure useActivityFeed passes event_type filter through to API in solune/frontend/src/hooks/useActivityFeed.ts
...
- [x] T022 [US3] Verify InfiniteScrollContainer integration and end-of-activity indicator in solune/frontend/src/pages/ActivityPage.tsx
...
- [x] T023 [US3] Verify cursor-based pagination consistency in solune/backend/src/api/activity.py
...
- [x] T024 [US4] Create useEntityHistory hook in solune/frontend/src/hooks/useEntityHistory.ts
...
- [x] T025 [P] [US4] Add collapsible History section to pipeline detail view in solune/frontend/src/components/pipeline/PipelineBoard.tsx
...
- [x] T026 [P] [US4] Add collapsible History section to chore detail view in solune/frontend/src/components/chores/ChoreInlineEditor.tsx
...
- [x] T027 [P] [US4] Add collapsible History section to agent detail view in solune/frontend/src/components/agents/AgentInlineEditor.tsx
...
- [x] T028 [P] [US4] Add collapsible History section to app detail view in solune/frontend/src/components/apps/AppDetailView.tsx
...
- [x] T029 [P] [US4] Add collapsible History section to tool detail view in solune/frontend/src/components/agents/ToolsEditor.tsx
...
- [x] T030 [US5] Replace empty placeholder with real activity feed query in solune/frontend/src/hooks/useNotifications.ts
...
- [x] T031 [US5] Add "View all" link navigating to /activity in notification bell dropdown in solune/frontend/src/layout/NotificationBell.tsx
...
- [x] T032 [US6] Add pipelinesApi.listRuns() and pipelinesApi.getRun() methods in solune/frontend/src/services/api.ts
...
- [x] T033 [US6] Create PipelineRunHistory component in solune/frontend/src/components/pipeline/PipelineRunHistory.tsx
...
- [x] T034 [US6] Add "Run History" tab/panel to pipeline editor view in solune/frontend/src/pages/AgentsPipelinePage.tsx
...
- [x] T035 [P] Run backend validation (ruff check, pyright, pytest) to confirm no regressions in solune/backend/
- [x] T036 [P] Run frontend validation (ESLint, tsc, vitest) to confirm no regressions in solune/frontend/
- [x] T037 Verify activity feed query performance with EXPLAIN QUERY PLAN on indexed query against 10K rows
- [x] T038 Run quickstart.md verification checklist end-to-end
