...
- [ ] T009 Register the pipelines router in backend/src/api/__init__.py by importing the new router and including it with prefix "/pipelines" and tags ["pipelines"], following the existing router registration pattern
